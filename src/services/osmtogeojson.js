      ...
      1: [
        function (e, t, n) {
          ...
          e('osm-polygon-features').forEach(function (e) {
            ...
            'all' === e.polygon
              ? (r[e.key] = !0)
              : ((t = 'whitelist' === e.polygon ? 'included_values' : 'excluded_values'),
                (n = {}),
          ...
          function P(e) {
            ...
            for (var r, o, i, a, u, s, l = []; e.length; )
              for (r = e.pop().nodes.slice(), l.push(r); e.length && !n(r[0], t(r)); ) {
          ...
          t.exports = (e = function (e, N, S) {
              ...
              F.isArray(r.nodes) ||
                ...
                F.each(e, function (e, t) {
                  ...
                  e.getAttribute('lat') &&
                    ...
                    (t = { type: 'node', id: (t = r.nodes[t]), lat: n, lon: e }),
                    s.push(t))
                })
            }
            function g(i, e) {
                  ...
                  F.each(e, function (e) {
                    ...
                    e.getAttribute('lat')
                      ? ((t = e.getAttribute('lat')),
                        (e = e.getAttribute('lon')),
                        (t = { type: 'node', id: '_anonymous@' + t + '/' + e, lat: t, lon: e }),
                        n.nodes.push(t.id),
                        s.push(t))
                      : n.nodes.push(void 0)
                  }),
                        ...
                        (F.each(e.getElementsByTagName('member'), function (e, t) {
                          ;(r[t] = {}),
                            ...
                            ((!o && 'node' == r[t].type && e.getAttribute('lat')) ||
                              ('way' == r[t].type && 0 < e.getElementsByTagName('nd').length)) &&
                              (o = !0)
                        }),
                        { type: 'relation' })
                    f(e, i, 'id'),
                    ...
                    function u(e) {
                      ...
                      e.members.forEach(function (e, t) {
                        ...
                        'node' == e.type
                          ...
                          : 'way' == e.type &&
                            e.geometry &&
                            ((e.ref = '_fullGeom' + e.ref), i(e.geometry, e.ref))
                      })
                    }
                            ...
                            f =
                              ...
                              c.members &&
                                c.members.some(function (e) {
                                  return (
                                    ('node' == e.type && e.lat) ||
                                    ('way' == e.type && e.geometry && 0 < e.geometry.length)
                                  )
                                }))
            ...
            function h(e, t, n) {
              function r(e, t) {
                if (('object' != typeof t && (t = {}), 'function' == typeof N.uninterestingTags))
                  return !N.uninterestingTags(e, t)
                for (var n in e)
                  if (!0 !== N.uninterestingTags[n] && !0 !== t[n] && t[n] !== e[n]) return 1
              }
              function p(e) {
                var t,
                  n = {
              ...
              for (var o = new Object(), i = new Object(), a = 0; a < e.length; a++)
                void 0 !==
                  (o[(f = void 0 !== o[(f = e[a]).id] ? N.deduplicator(f, o[f.id]) : f).id] = f)
                    .tags &&
                  r(f.tags) &&
                  (i[f.id] = !0)
              for (a = 0; a < n.length; a++)
                if (F.isArray(n[a].members))
                  for (var u = 0; u < n[a].members.length; u++)
                    'node' == n[a].members[u].type && (i[n[a].members[u].ref] = !0)
              for (var y = new Object(), s = new Object(), a = 0; a < t.length; a++) {
                var l = t[a]
                if (
                  (y[l.id] && (l = N.deduplicator(l, y[l.id])), (y[l.id] = l), F.isArray(l.nodes))
                )
              ...
              for (var d = new Array(), a = 0; a < n.length; a++)
                d[(m = d[(m = n[a]).id] ? N.deduplicator(m, d[m.id]) : m).id] = m
              var g,
                h,
                b = { node: {}, way: {}, relation: {} }
              for (g in d) {
                ...
                if (F.isArray(m.members))
                  for (u = 0; u < m.members.length; u++) {
                    ...
                    'number' != typeof _ && (_ = _.replace('_fullGeom', '')),
                      b[v]
                        ? (void 0 === b[v][_] && (b[v][_] = []),
                          b[v][_].push({ role: m.members[u].role, rel: m.id, reltags: m.tags }))
                        : N.verbose &&
                          console.warn(
                            'Relation',
                            m.type + '/' + m.id,
              ...
              for (a = 0; a < c.length; a++)
                void 0 === c[a].lon || void 0 === c[a].lat
                  ...
                  : ((E = {
                    ...
                    c[a].__is_center_placeholder && (E.properties.geometry = 'center'),
                    S ? S(E) : w.push(E))
              for (var j = [], A = [], a = 0; a < n.length; a++)
                if (d[n[a].id] === n[a]) {
                    ...
                    if (
                      ...
                      !1 ===
                        (E = (function (n) {
                          ...
                          r &&
                            (N.verbose && console.warn('Route', n.type + '/' + n.id, 'is tainted'),
                  ...
                  if (
                    void 0 !== n[a].tags &&
                    ('multipolygon' == n[a].tags.type || 'boundary' == n[a].tags.type)
                  ) {
                    if (F.isArray(n[a].members)) {
                    ...
                    function T(e, t) {
                            ...
                            (function (e, t) {
                              for (var n = 0; n < t.length; n++)
                                if (
                                  (function (e, t) {
                                    for (
                                      var n = e[0], r = e[1], o = false, i = 0, a = t.length - 1;
                                      i < t.length;
                                      a = i++
                                    ) {
                                      var u = t[i][0],
                      ...
                      return 0 ==
                        ...
                        ? (N.verbose &&
                            console.warn('Multipolygon', r + '/' + o, 'contains no coordinates'),
                          !1)
                        : ((f = 'MultiPolygon'),
                          ...
                          n &&
                            (N.verbose && console.warn('Multipolygon', r + '/' + o, 'is tainted'),
                ...
                if (y[t[a].id] === t[a])
                  if (F.isArray(t[a].nodes)) {
                    if (!t[a].is_skippablerelationmember) {
                      'number' != typeof t[a].id && (t[a].id = +t[a].id.replace('_fullGeom', '')),
                        (t[a].tainted = !1),
                        (t[a].hidden = !1)
                      var M,
                        B = new Array()
                      ...
                      B.length <= 1
                        ...
                        : ((M = 'LineString'),
                          ...
                          t[a].tainted &&
                            (N.verbose &&
                              console.warn('Way', t[a].type + '/' + t[a].id, 'is tainted'),
                            (E.properties.tainted = !0)),
                          t[a].__is_bounds_placeholder && (E.properties.geometry = 'bounds'),
              ...
              return (
                ...
                N.flatProperties &&
                  h.features.forEach(function (e) {
                    e.properties = F.merge(e.properties.meta, e.properties.tags, {
            ...
            !function () {
              !function () {
                var R,
                  ...
                  t = {},
                  d =
                    ((t[O] = t[E] = t[x] = t[T] = t[M] = t[B] = t[N] = t[S] = t[F] = !0),
                    (t[C] =
                      t[ee] =
                      t[se] =
                      t[te] =
                ...
                var Ee = Array.prototype,
                  ...
                  Te = (o = /[^.]+$/.exec((o && o.keys && o.keys.IE_PROTO) || ''))
                    ? 'Symbol(src)_1.' + o
                    : '',
                  Me = r.toString,
                  q = xe.hasOwnProperty,
                ...
                function Je(e, t) {
                  var n,
                    ...
                    i = !!o
                  for (n in e)
                    (!t && !q.call(e, n)) || (i && ('length' == n || vt(n, o))) || r.push(n)
                  return r
                }
                function Ke(e, t, n) {
                  ;((n === R || J(e[t], n)) && ('number' != typeof t || n !== R || t in e)) ||
                    (e[t] = n)
                }
                function Qe(e, t, n) {
                  var r = e[t]
                  ...
                  if ((u = i ? (t ? i(n, e, t, a) : i(n)) : u) === R) {
                    ...
                    if (e) {
                      ...
                      if (Mt(n))
                        return (
                          (s = n),
                          (l = r) ? s.slice() : ((l = new s.constructor(s.length)), s.copy(l), l)
                        )
                      if (c == G || c == C || (f && !t)) {
                        if (W(n)) return t ? n : {}
                        if (
                          ((u =
                            'function' != typeof (s = f ? {} : n).constructor || wt(s)
                              ? {}
                              : (function (e) {
                                  return Q(e) ? Le(e) : {}
                                })(Fe(s))),
                          ...
                          return (f = l = n), (f = (y = u) && gt(f, Z(f), y)), gt(l, mt(l), f)
                      } else {
                        if (!d[c]) return t ? n : {}
                        u = (function (e, t, n, r) {
                          var o = e.constructor
                ...
                ;(l.prototype.clear = function () {
                  ...
                  (c.prototype.delete = function (e) {
                    var t = this.__data__
                    return (
                      !((e = Ye(t, e)) < 0) && (e == t.length - 1 ? t.pop() : Re.call(t, e, 1), !0)
                    )
                  }),
                ...
                function ot(e, t) {
                  for (var n = 0, r = (t = _t(t, e) ? [t] : pt(t)).length; null != e && n < r; )
                    e = e[Ot(t[n++])]
                  return n && n == r ? e : R
                }
                function it(e, t) {
                  ...
                  if (l) {
                    ...
                    for (var N = !0, S = (O.set(_, w), O.set(w, _), E); ++M < T; ) {
                      ...
                      var F,
                        ...
                        P = w[B]
                      if (
                        !((F = A ? (E ? A(P, L, B, w, _, O) : A(L, P, B, _, w, O)) : F) === R
                          ? L === P || j(L, P, A, k, O)
                          : F)
                      ) {
                        N = !1
                ...
                function ft(s, l) {
                  return (
                    ...
                    function () {
                      for (
                        var e = arguments, t = -1, n = $e(e.length - l, 0), r = Array(n);
                        ++t < n;
                ...
                function St(e) {
                  return (
                    !(!Y(e) || i.call(e) != G || W(e)) &&
                    (null === (e = Fe(e)) ||
                      ('function' == typeof (e = q.call(e, 'constructor') && e.constructor) &&
                        e instanceof e &&
                        Me.call(e) == Be))
                  )
                }
                    ...
                    for (
                      i &&
                        (function (e, t, n) {
                          if (Q(n)) {
                            var r = typeof t
                            if ('number' == r ? g(n) && vt(t, n.length) : 'string' == r && (t in n))
                              return J(n[t], e)
                          }
                          return
                        })(t[0], t[1], i) &&
